    ...
    return (
        <>
            ...
            <div className="w-full h-[calc(100%_-_4rem)] flex flex-col items-center justify-center">
                ...
                {signUp &&
                <>
                    <form action="" method="post" className="" onChange={setConfirmed}>
                        <input type="text" name="email" id="email" className="w-full h-12 bg-slate-100 rounded px-5 py-5 border border-slate-300 mb-6 outline-none focus:bg-slate-200 transition duration-300 focus:border-blue-500 focus:border-2 focus:scale-110" placeholder="Email address" required /><br />
                        <input type="password" name="password" id="password" className="w-full h-12 bg-slate-100 rounded px-5 py-5 border border-slate-300 outline-none focus:bg-slate-200 transition duration-300 focus:border-blue-500 focus:border-2 focus:scale-110" placeholder="Password" required onChange={(event) => getPassword(event)} /><br />
                        {passwordConfirmed ?
                            <input type="password" name="confirm-password" id="confirm-password" className="w-full h-12 bg-slate-100 rounded px-5 py-5 border border-green-500 outline-none focus:bg-slate-200 transition duration-300 focus:border-blue-500 focus:border-2 focus:scale-110 mt-6" placeholder="Confirm Password" required onChange={getPassConf} /> :
                            <input type="password" name="confirm-password" id="confirm-password" className="w-full h-12 bg-slate-100 rounded px-5 py-5 border border-red-500 outline-none focus:bg-slate-200 transition duration-300 focus:border-blue-500 focus:border-2 focus:scale-110 mt-6" placeholder="Confirm Password" required onChange={getPassConf} />
                        }
                        {passwordConfirmed ?
